...
/*
   ...
   19May
   Implementado que guarde el puntero cada tanto.
...
void arrayReadSD() {//obtengo posiciones de la tarjeta SD
  ...
  //solo hago getPuntero() si se cortó la luz n el setup()
  ...
  if (myFileX.available() > 0) {//me fijo si todavía hay datos para leer
    ...
    //NOTA: yo agregaría un botón para setear los punteros en cero
    //para no tener que hacerlo manualmente cada vez que queramos que empiece
