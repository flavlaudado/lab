...
const PROGMEM uint16_t pixelX[] = {  1000, 500, 500, 200, 200};
const PROGMEM uint16_t pixelY[] = {  0, 50, 500, 500, 100};
...
long arraySize = 5;//726; //cantidad de fijaciones
long n = 1;
long m = 0;
...
int valSensor = LOW;//prender máquina, sin rollo tienen sentido?
int flag = LOW;
...
const int thresholdEndStopY = 50;
int valEndY;
