...
/*
   ...
   17May
   Quedó sin funcionar lo de SD, sospecho de la tarjeta, me dice q no tiene más para leer. SOLUCIONADO era que funciona con 3V3
...
void arrayReadSD() {//obtengo posiciones de la tarjeta SD
  ...
  if ( flagFindZero == false ) {
    ...
    r++;
    if (r > n) { //guardo el puntero cada n fijaciones
